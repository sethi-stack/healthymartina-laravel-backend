...
function renderFooterStyles() {
  ...
  .pdf-footer--compact{height:12mm}
  ...
  .pdf-footer--compact .pdf-footer__logo img{max-height:10mm;max-width:28mm}
  ...
  .pdf-footer--compact .pdf-footer__name{font-size:8pt}
  .pdf-footer--compact .pdf-footer__email{font-size:7.5pt}`;
}
...
function renderFooter(model, options = {}) {
  ...
  return `<div class="pdf-footer${compactClass}">
