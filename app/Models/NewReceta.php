...
class NewReceta extends Model
{
    ...
    {
        return $this->hasMany('App\Models\RecetaResultado', 'receta_id')->orderBy('active', 'asc', 'created_by', 'asc')->orderBy('created_at', 'asc');
    }

    public function recetaInstruccionReceta()
    {
        return $this->hasMany('App\Models\RecetaInstruccionReceta', 'receta_id')->orderBy('id', 'asc');
    }
