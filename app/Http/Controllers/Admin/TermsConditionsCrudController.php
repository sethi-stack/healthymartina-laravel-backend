...
class TermsConditionsCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\TermsConditions::class);
        CRUD::setRoute(config("backpack.base.route_prefix") . "/terms-conditions");
        CRUD::setEntityNameStrings("términos y condiciones", "términos y condiciones");
    }
