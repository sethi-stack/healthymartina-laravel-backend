...
class InstruccionCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Instruccion::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/Instrucciones');
        CRUD::setEntityNameStrings('instrucción', 'instrucciones');
    }
