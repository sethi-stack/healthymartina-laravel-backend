...
class EquivalenceCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Equivalence::class);
        CRUD::setRoute(config("backpack.base.route_prefix") . "/equivalence");
        CRUD::setEntityNameStrings("equivalencia", "equivalencias");
    }
