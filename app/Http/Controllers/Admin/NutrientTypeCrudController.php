...
class NutrientTypeCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\NutrientType::class);
        CRUD::setRoute(config("backpack.base.route_prefix") . "/nutrienttype");
        CRUD::setEntityNameStrings("tipo de nutriente", "tipos de nutriente");
    }
